...
We will compare all three models on the test set. Based on the test set, it appears that is the best model. 
...
#Use the best logistic model (log_fit_3) to predict the probability of success.
...
saveRDS(log_fit_3, file = "log_fit_3.rds")
