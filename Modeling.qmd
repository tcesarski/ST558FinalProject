...
## Best Logistic Model 
Based on the three previous logistic models, Logistic Model #3 appears to be the best with the lowest logloss metric.
...
We will compare all three models on the test set.

```{r}
#Logistic Model
library(Metrics)
actual <- as.numeric(diabetes_test$Diabetes_binary)
